        ...
        <div class="flex justify-between items-center">
          <ul class="flex items-center gap-[5px] xl:gap-[20px] text-[14px]">
            ...
            <li
              class="text-[#383B63] p-[10px] hover:bg-[#6DC06E] hover:text-white cursor-pointer"
              :class="
                $route.path === '/partners/businesses' ? 'bg-[#6CC06D] text-white' : null
              "
            >
      ...
      <div class="w-[85%] xl:w-[1200px] mx-auto">
        ...
        >
          <div>
            ...
            <p class="text-[14px] md:text-[16px]">
              <span class="block mb-[10px]">
                Demonstrate to your commercial clients that improved goods, services, and
                costs are available.
              </span>
              <span class="block">
                Utilising your proficiency in serving businesses and our fibre-only
                infrastructure explicitly designed for the digital era, we can provide
                connections that instil new trust.
              </span>
            </p>
          </div>
          ...
          <div class="w-full h-[250px] md:h-[400px]">
            <img
              src="../../assets/images/businesses.jpg"
              alt="afl network"
