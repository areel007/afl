        ...
        >
          <div>
            ...
            <p class="text-[14px] md:text-[16px]">
              Our aerial fibre-only network is a cutting-edge optical
              infrastructure that meets the growing demands of Mobile Network
              Operators (MNOs), TowerCos, and Wireless Operators.
              <br /><br />
              With the rapid advancement of 5G technology and its ultra-low
              latency applications, it's crucial to have a network that can
              withstand the test of time.
              <br /><br />
              Our partners enjoy access to top-notch products,
              cost-effectiveness, and services throughout Lagos.
            </p>
          </div>
